...
from model_2D_cGAN_upd_globalNorm_RB import GeneratorUNet, Discriminator, PerceptualLoss
...
def load_checkpoint(generator, discriminator, optimizer_G, optimizer_D, filename="checkpoint_RB.pth"):
...
def main():
    ...
    writer = SummaryWriter('runs/cgan_RB')
    ...
    torch.save(generator.state_dict(), 'generator_RB.pth')
    torch.save(discriminator.state_dict(), 'discriminator_RB.pth')

    with open('patient_normalization_paramsRB.json', 'w') as f:
