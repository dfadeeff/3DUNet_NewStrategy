...
class Generator(nn.Module):
    def __init__(self, out_channels=1):
        ...
        self.encoder_mod1 = models.resnet34(pretrained=True)
        self.encoder_mod2 = models.resnet34(pretrained=True)
        self.encoder_mod3 = models.resnet34(pretrained=True)
        ...
        # Fusion layers with corrected channel sizes
        self.fusion0 = AttentionFusion(channels=64)    # Output of conv1
        self.fusion1 = AttentionFusion(channels=64)    # Output of maxpool
        self.fusion2 = AttentionFusion(channels=64)    # Output of layer1
        self.fusion3 = AttentionFusion(channels=128)   # Output of layer2
        self.fusion4 = AttentionFusion(channels=256)   # Output of layer3

        # Decoder blocks with adjusted in_channels
        self.decoder4 = self._decoder_block(512 + 256, 256)  # 512 (upsampled) + 256 (skip connection)
        self.cbam4 = CBAM(256)
        ...
        self.decoder0 = self._decoder_block(64 + 64, 64)
        self.cbam0 = CBAM(64)
