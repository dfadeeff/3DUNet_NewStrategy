...
def save_checkpoint(generator, discriminator, optimizer_G, optimizer_D, epoch, loss,
                    filename="checkpoint_cgan_enhancedEnh_opt.pth"):
    torch.save({
        'epoch': epoch,
...
def load_checkpoint(generator, discriminator, optimizer_G, optimizer_D, filename="checkpoint_cgan_enhancedEnh_opt.pth"):
...
def main():
    ...
    writer = SummaryWriter('runs/cgan_training_opt')
    ...
    torch.save(generator.state_dict(), 'generator_final_opt.pth')
    torch.save(discriminator.state_dict(), 'discriminator_final_opt.pth')

    with open('patient_normalization_params_cgan_opt.json', 'w') as f:
