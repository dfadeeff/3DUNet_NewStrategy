...
def save_checkpoint(generator, discriminator, optimizer_G, optimizer_D, epoch, loss,
                    filename="checkpoint_cgan_globalNormBrats24.pth"):
    torch.save({
        'epoch': epoch,
...
def load_checkpoint(generator, discriminator, optimizer_G, optimizer_D, filename="checkpoint_cgan_globalNormBrats24.pth"):
...
def main():
    ...
    writer = SummaryWriter('runs/cgan_globalNormBrats24')
    ...
    torch.save(generator.state_dict(), 'generator_globalNormBrats24.pth')
    torch.save(discriminator.state_dict(), 'discriminator_globalNormBrats24.pth')

    with open('patient_normalization_params_cgan_globalNormBrats24.json', 'w') as f:
