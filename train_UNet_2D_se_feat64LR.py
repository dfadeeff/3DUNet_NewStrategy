...
def save_checkpoint(model, optimizer, epoch, loss, filename="checkpoint_2d_se_f64LR.pth"):
    torch.save({
        'epoch': epoch,
...
def load_checkpoint(model, optimizer, filename="checkpoint_2d_se_f64LR.pth"):
...
def main():
    ...
    writer = SummaryWriter('runs/2d_unet_se_f64LR')
    ...
    torch.save(model.state_dict(), '2d_unet_model_se_f64f64LR.pth')

    with open('patient_normalization_params_2d_se_f64f64LR.json', 'w') as f:
