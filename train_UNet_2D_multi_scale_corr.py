...
def main():
    ...
    writer = SummaryWriter('runs/2d_unet_experiment_full_image_multi_scale_corr')
    ...
    torch.save(model.state_dict(), '2d_unet_model_final_multi_scale_corr.pth')

    with open('patient_normalization_params_2d_multi_scale_corr.json', 'w') as f:
